/*!
 * i-app's Gruntfile
 * http://iapp-framework.ir
 * Copyright 2018 Arash Ataei
 * Licensed under MIT (https://github.com/arashataei/i-app/blob/master/LICENSE)
 */
...
module.exports = function(grunt) {
  ...
  var generateRatchiconsData = require('./grunt/i-appicons-data-generator.js');
  ...
  grunt.initConfig({
    ...
    banner: '/*!\n' +
            ' * =====================================================\n' +
            ' * i-app framework v<%= pkg.version %> (<%= pkg.homepage %>)\n' +
            ' * Copyright <%= grunt.template.today("yyyy") %> <%= pkg.author %>\n' +
            ' * Licensed under <%= pkg.license %> (https://github.com/arashataei/i-app/blob/master/LICENSE)\n' +
            ' *\n' +
            ' * v<%= pkg.version %> designed by @arashataei.\n' +
            ' * =====================================================\n' +
            ' */\n',
    ...
    sass: {
      ...
      dist: {
        files: {
          '<%= meta.distPath %>css/<%= pkg.name %>.css': 'sass/i-app.scss',
